...
function toErrorMeta(error) {
  ...
  return {
    ...
    errorMessage: safeString(error?.message, 900),
    ...
    axiosResponseDataSnippet: isAxios ? safeString(error?.response?.data, 700) : null,
...
async function syncEmployeeLabels({
  ...
  debugLog("rtbt_label_decision_snapshot", {
    objectId: String(objectId),
...
async function processOneRecord({
  ...
  debugLog("rtbt_hs_source_snapshot", {
    objectId: String(objectId),
    source: {
      bt_name: props?.bt_name,
      date_of_birth: props?.date_of_birth,
      email: props?.email,
      street_home: props?.street_home,
      home_apt: props?.home_apt,
      location_city: props?.location_city,
      location_home: props?.location_home,
      postal_code_home: props?.postal_code_home,
      employee_phone: props?.employee_phone,
      bt_rbt_type: props?.bt_rbt_type,
      street_address__work_: props?.street_address__work_,
      city__work_: props?.city__work_,
      state__work_: props?.state__work_,
      postal_code__work_: props?.postal_code__work_,
    },
  });
  debugLog("rtbt_mapped_payload_snapshot", {
    objectId: String(objectId),
    outboundEmployeePayload: employeePayload,
    derived: {
      btRbtType,
      stateCodeForLabels,
    },
  ...
  debugLog("rtbt_payload_selected_for_cr", {
    objectId: String(objectId),
